...
import "../../Assets/style.css"; // ajuste o caminho conforme sua estrutura
      ...
      <main>
        <section className="home-hero">
          <div className="container hero-content">
            ...
            <p>
              iStore er Danmarks destination for de nyeste Macs, iPhones og iPads. 
              Vi forener passion for teknologi med kompromisløs kvalitet.
            </p>
          </div>
        </section>
      ...
      <footer className="apple-footer">
        <div className="container footer-content">
          ...
          <div className="footer-info">
            Alle produkter er gennemtestet og klar til brug. <br />
            Hurtig dag-til-dag levering i hele landet.
          </div>
        </div>
      </footer>
